const CONTENT__DATA = [
    {
      ...
      title: "Trending",
      type: { _id: "60e0bb71f84ac80015b1a581", rows: false, dropDown: false },
    },
    {
      entries: [
        {
      ...
      type: { _id: "60e0bb71f84ac80015b1a582", rows: true, dropDown: false },
    },
    {
      entries: [
        {
        ...
        },
        {
          ...
          entries: [
            {
              title: "Books",
              entries: [{ title: "Books" }, { title: "Kindle Books" }],
            },
            {
      ...
      type: { _id: "60e0bb71f84ac80015b1a583", rows: true, dropDown: true },
    },
    {
      entries: [
      ...
      type: { _id: "60e0bb71f84ac80015b1a584", rows: true, dropDown: true },
    },
    {
      entries: [
        { title: "Your Account" },
      ...
      title: "Help & Settings",
      type: { _id: "60e0bb71f84ac80015b1a585", rows: false, dropDown: false },
    },
  ];
  
  export default CONTENT__DATA;
